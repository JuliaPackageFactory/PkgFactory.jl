...
[![Citation](https://img.shields.io/badge/citation-CFF-7A8288)](https://github.com/{{{OWNER}}}/{{{PKG}}}.jl/blob/main/CITATION.cff)
...
Use [CITATION.cff](https://github.com/{{{OWNER}}}/{{{PKG}}}.jl/blob/main/CITATION.cff) to cite this package, or [download the BibTeX citation](assets/citation.bib).

```@example
import {{{PKG}}} # hide
println(read(joinpath(pkgdir({{{PKG}}}), "docs", "src", "assets", "citation.bib"), String)) # hide
```
